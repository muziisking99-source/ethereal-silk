      ...
      <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          ...
          <div className="absolute bottom-8 -right-4 lg:-right-8 bg-[var(--surface-2)] border border-[rgba(var(--accent-rgb),0.25)] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.6)] rounded-[4px]">
            ...
            <div className="font-[Cormorant_Garamond] text-[2rem] font-bold text-[var(--text)] leading-none">
              {content.badge_year}
            </div>
          </div>
        </motion.div>
        ...
        >
          {isLoading ? (
            <div className="h-64 bg-[var(--bg2)] animate-pulse rounded-[4px]" />
          ) : (
            <>
              <div className="font-[DM_Mono] text-[0.62rem] tracking-[0.35em] uppercase text-[var(--accent)] mb-3">
                {content.eyebrow}
              </div>
              <h2 className="font-[Cormorant_Garamond] text-[clamp(2rem,4vw,3.2rem)] font-bold leading-[1.1] mb-6 text-[var(--text)]">
                {content.heading}
              </h2>
              <p className="text-[0.95rem] leading-[1.9] text-[var(--muted)] mb-5 font-light font-[Jost]">
                {content.paragraph1}
              </p>
              <p className="text-[0.95rem] leading-[1.9] text-[var(--muted)] mb-8 font-light font-[Jost]">
                {content.paragraph2}
              </p>
